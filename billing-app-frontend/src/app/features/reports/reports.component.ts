...
import { SalesReportDto, StockReportItemDto } from '../../core/models/models';
      ...
      <div *ngIf="activeTab === 'sales'">
        ...
        <div *ngIf="salesReport">
          ...
          <div class="kpi-grid mb-6">
            ...
            <div class="stat-card">
              <div class="stat-value text-success">{{ salesReport.paidBills }}</div>
          ...
          <div class="card" style="padding:0">
            ...
            <div class="table-wrapper">
              <table class="table">
                ...
                <tbody>
                  <tr *ngFor="let row of salesReport.items">
...
export class ReportsComponent implements OnInit {
  ...
  drawChart(): void {
    ...
    this.chart = new Chart(this.salesChartRef.nativeElement, {
      type: 'bar',
      data: {
        labels: this.salesReport.items.map(i => i.label),
        datasets: [{
          label: 'Revenue (₹)',
